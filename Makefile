.PHONY: all clean clean-bin derust debug bindir build build-windows build-mac test test-rust test-godot test-sanity bench bench-rust bench-godot bundle godot-abyss-release godot-abyss-debug doc doc-clean doc-gdscript doc-gdextension doc-rust sphinx
...
doc: doc-gdscript doc-gdextension doc-rust
